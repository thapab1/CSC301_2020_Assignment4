<form action="edit.php?id=<? echo $id; ?>" method="POST" role="form">
    ...
    <div class="form-group row">
        ...
        value=<?= $apartments[$id]['house-img'] ?> required>
    </div>
    <div class="form-group">
        <label for="description">Description:</label>
        <textarea type="text" class="form-control col-sm-7" rows="4" cols="50" name="description" required><?= $apartments[$id]['description'] ?></textarea>
    </div>
    <div class="form-group row">
    ...
    <div class="form-group row">
        ...
        value=<?= $apartments[$id]['price'] ?> required>
    </div>
    <div class="form-group row">
